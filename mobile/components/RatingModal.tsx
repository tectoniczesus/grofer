...
import { Modal, TouchableWithoutFeedback ,View,Text, ScrollView, TouchableOpacity, ActivityIndicator} from "react-native";
...
const RatingModal = ({visible, onClose, order,productRating,onRatingChange,
       ...
       <TouchableWithoutFeedback onPress={onClose}>
        <View className="flex-1 bg-black/70 items-center justify-center px-4">
          ...
          <Ionicons name="star" size={32} color="#1DB954"/>
                  ...
                  >Rate each product from your product</Text>
                 </View>
                 <ScrollView className="mb-4">
                  ...
                  <View className="flex-1 ml-3">
                    ...
                    <Text className="text-text-secondary text-xs mt-1">Qty: {item.quantity} . ${item.price.toFixed(2)}</Text>
                  </View>
                </View>
