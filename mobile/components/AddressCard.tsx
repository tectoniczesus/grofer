...
export default function AddressCard({address,onEdit,onDelete,isUpdatingAddress,
  isDeletingAddress}:AddressCardProps) {
  return (
    <View className="bg-surface rounded-3xl p-5 mb-3">
      ...
      <View className="flex-row mt-4 gap-2">
        <TouchableOpacity
          className="flex-1 bg-green-500/30 py-3 rounded-xl items-center"
          activeOpacity={0.7}
          onPress={() => onEdit(address)}
          disabled={isUpdatingAddress}
        >
          <Text className="text-green-600 font-bold">Edit</Text>
        </TouchableOpacity>
        <TouchableOpacity
