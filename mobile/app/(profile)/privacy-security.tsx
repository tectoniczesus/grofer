import { View,Text, TouchableOpacity, ScrollView, Settings, Switch } from "react-native";
...
function privacyAndSecurity(){
   ...
   const securitySetting: SecurityOption[]=[
    {
        id:"password",
    ...
    <SafeScreen>
     ...
     > 
      ...
      <View className="px-4 pt-4">
        <Text className="text-text-primary font-bold mb-4 text-lg">Privacy</Text>
    ...
    <Text className="text-text-primary text-lg font-bold mb-4">Account</Text>
       {accountSettings.map((setting)=>(
        ...
        >
         <View className="flex-row items-center">
            <View className="bg-primary/20 rounded-full w-12 h-12 items-center justify-center mr-4">
                <Ionicons name={setting.icon as any} size={28} color="#1DB954"/>
            </View>
            <View className="flex-1">
                <Text className="text-text-primary font-bold text-base mb-1">
                    {setting.title}
   ...
   <View className="px-6 pt-4">
        ...
        <View className="px-6 pt-6 pb-4">
          <View className="bg-green-800/20 rounded-2xl p-4 flex-row">
