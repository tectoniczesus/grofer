...
function AddressesScreen(){
   const {addresses,addAddress,updateAddress,deleteAddress,isAddingAddress,isUpdatingAddress,isDeletingAddress,isLoading,isError}=useAddresses();
        ...
        <View className="flex-1 items-center justify-center px-6">
         ...
         >
          <View className="px-6 py-4">
            ...
            <TouchableOpacity
              className="bg-blue-400 rounded-2xl py-4 items-center mt-2"
              activeOpacity={0.8}
              onPress={handleAddAddress}
            >
