...
function WishlistScreen(){
    ...
    const handleRemovingFromWishlist = (productId:string,productName:string)=>{
    ...
    const handleAddToCart = (productId:string, productName: string )=>{
        ...
        addToCart(
            ...
            {
                onSuccess:()=>Alert.alert("Success",`Success ${productName} added to cart`),
                onError:(error:any)=>{
            ...
            >
             ...
             {wishlist.map((item)=>(
                ...
                >
                   ...
                   activeOpacity={0.7}
                   onPress={()=> handleRemovingFromWishlist(item._id, item.name)}
                   ...
                   >
                    ...
                    {item.stock > 0 && (
                        ...
                        <View className="px-4 pb-4">
                         <TouchableOpacity
                          className="bg-yellow-50 rounded-xl py-3 items-center"
                          activeOpacity={0.8}
