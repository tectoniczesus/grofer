...
const ProductDetailScreen = () => {
 ...
 const inStock = product?.stock && product.stock > 0;
    ...
    return(
    <SafeScreen>
        <View className='absolute top-0 left-0 right-0 z-10 px-6 pt-6 pb-4 flex-row items-center justify-between'>
            <TouchableOpacity
            className='bg-black/40 backdrop-blur-xl w-12 h-12 rounded-full items-center justify-center'
            onPress={()=> router.back()}
            activeOpacity={0.9}
            >
